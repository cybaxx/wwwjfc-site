<script>
    ...
    $effect(() => {
        ...
        // Afterimage Pass for trailing effect (skip if reduced motion)
        let afterimagePass;
        ...
        const handleVisibility = () => {
            ...
            if (tabVisible) previousTime = performance.now();
        };
        ...
        const animate = function () {
            ...
            scene.rotation.x += 0.0025 * rotationSpeed;
            scene.rotation.y += 0.0025 * rotationSpeed;

            // Rotate the orbit pivot
            orbitPivot.rotation.y += 0.005 * rotationSpeed;
...
<style>
    ...
    :global(html, body) {
        ...
        margin: 0;
        padding: 0;
        overflow: auto; /* Allow scrolling the page content */
    }
</style>
